...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String accompanimentPriceAndroidStringFormattedPriceViewModelAccompanimentPrice = null;
        ...
        java.lang.String entreePriceAndroidStringFormattedPriceViewModelEntreePrice = null;
        java.lang.String sidePriceAndroidStringFormattedPriceViewModelSidePrice = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x181L) != 0) {
                    ...
                    // read @android:string/formatted_price
                    accompanimentPriceAndroidStringFormattedPriceViewModelAccompanimentPrice = accompanimentPrice.getResources().getString(R.string.formatted_price, viewModelAccompanimentPrice);
            }
            ...
            if ((dirtyFlags & 0x184L) != 0) {
                    ...
                    // read @android:string/formatted_price
                    entreePriceAndroidStringFormattedPriceViewModelEntreePrice = entreePrice.getResources().getString(R.string.formatted_price, viewModelEntreePrice);
            }
            ...
            if ((dirtyFlags & 0x190L) != 0) {
                    ...
                    // read @android:string/formatted_price
                    sidePriceAndroidStringFormattedPriceViewModelSidePrice = sidePrice.getResources().getString(R.string.formatted_price, viewModelSidePrice);
            }
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentPrice, accompanimentPriceAndroidStringFormattedPriceViewModelAccompanimentPrice);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreePrice, entreePriceAndroidStringFormattedPriceViewModelEntreePrice);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.entreeSelection, viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.sidePrice, sidePriceAndroidStringFormattedPriceViewModelSidePrice);
